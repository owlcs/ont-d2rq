...
public class ExamplesTest {
    ...
    public static final String SCHEMA_LOCATION_URI = "file:doc/terms/d2rq.ttl";
    public static final String SCHEMA_URI = "http://d2rq.org/terms/d2rq";

    @Test
    public void testAssemblerExample() {
        FileManager.get().getLocationMapper().addAltEntry(SCHEMA_URI, SCHEMA_LOCATION_URI);
