...
public class MappingImpl implements Mapping, ConnectingMapping {
    ...
    public Graph getSchema() {
        // no need right now:
        /*if (getConfiguration().getControlOWL() && !hasAutoGenerated()) {
            compileOWL();
        }*/
        return schemaGenerator.createMagicGraph(this);
    }
    ...
    public void validate(boolean withDBConnectivity) throws D2RQException {
        ...
        if (listDatabases().peek(MapObject::validate).count() == 0) { // todo: duplicate jdbcDSNs ?
