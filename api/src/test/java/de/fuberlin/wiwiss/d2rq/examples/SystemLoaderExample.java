...
public class SystemLoaderExample {
    ...
    public static void main(String[] args) {
        ...
        loader.setUsername("d2rq")
                .setStartupSQLScript(TestConstants.SCRIPT)
        ...
        for (TripleRelation internal : MappingHelper.asConnectingMapping(mapping).compiledPropertyBridges()) {
        ...
        loader = new SystemLoader()
                .setMappingFileOrJdbcURL(TestConstants.MAPPING)
                .setFastMode(true)
