...
public interface Vendor {
    ...
    Vendor SQL92 = new SQL92(true);
    Vendor MySQL = new MySQL();
    Vendor PostgreSQL = new PostgreSQL();
    Vendor InterbaseOrFirebird = new SQL92(false);
    Vendor Oracle = new Oracle();
    Vendor SQLServer = new SQLServer();
    Vendor MSAccess = new SQLServer(); // TODO
    Vendor HSQLDB = new HSQLDB();
